                ...
                <tbody>
                   ...
                   @if(isset($health))
                    ...
                    <tr role="row" class="odd" id="row-{{7}}">
                        ...
                        <td class="{{($health['g']->answer == 'yes') ? 'yes' : 'no'}} align-center" >
                            {{ $health['g']->answer }}
                        </td>
                    ...
                    <tr role="row" class="odd" id="row-{{10}}">
                        ...
                        <td class="{{($health['j']->answer == 'no') ? 'yes' : 'no'}} align-center" >
                            {{ $health['j']->answer }}
                        </td>
                    ...
                    <tr role="row" class="odd" id="row-{{17}}">
                        ...
                        <td>{{$health['p']->question }}</td>
                        <td class="{{($health['p']->answer == 'no') ? 'yes' : 'no'}} align-center" >
                            {{ $health['p']->answer }}
                        </td>
                        <td>{!!$health['p']->comment !!}</td>
                    </tr>
                    <tr role="row" class="odd" id="row-{{18}}">
                        ...
                        <td class="{{($health['q']->answer == 'no') ? 'yes' : 'no'}} align-center" >
                            {{ $health['q']->answer }}
                        </td>
                    ...
                    <tr role="row" class="odd" id="row-{{19}}">
                        ...
                        <td class="{{($health['r']->answer == 'no') ? 'yes' : 'no'}} align-center" >
                            {{ $health['r']->answer }}
                        </td>
                    ...
                    <tr role="row" class="odd" id="row-{{21}}">
                        ...
                        <td class="{{($health['t']->answer == 'no') ? 'yes' : 'no'}} align-center" >
                            {{ $health['t']->answer }}
                        </td>
                    ...
                    <tr role="row" class="odd" id="row-{{22}}">
                        ...
                        <td class="{{($health['u']->answer == 'no') ? 'yes' : 'no'}} align-center" >
                            {{ $health['u']->answer }}
                        </td>
                    ...
                    <tr role="row" class="odd" id="row-{{25}}">
                        <td tabindex="0" class="sorting_1">{{25}}</td>
                        <td>Completed By</td>
                        <td class=" align-center" >
                        {{$health['a']->user->name}}
                        </td>
