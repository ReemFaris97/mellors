...
<div id="datatable-buttons_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
    <div class="row">
        ...
        <table id="datatable-buttons" class="table {{  (request()->is('search_ride_ops_reports*')) ? 'Rides' : 
                                            ((request()->is('search_health_and_safety*')) ? 'TechServices Health health1' : 
                                            ((request()->is('search_maintenance_reports*')) ? 'Maintenance' : 
                                            ((request()->is('search_tech_reports*')) ? 'TechServices' : 
                                            ((request()->is('search_skill_game_reports*')) ? 'SkillGames' : '')))) }} table-striped table-bordered dt-responsive nowrap">
                             <thead>
                    <tr role="row">
...
<div id="datatable-buttons_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
    <div class="row">
        <div class="col-sm-12">
            <table id="datatable-buttons" class="table Health health1 table-striped table-bordered dt-responsive nowrap">
                <thead>
                    <tr role="row">
                        <th class="sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1"
                            aria-sort="ascending">ID
