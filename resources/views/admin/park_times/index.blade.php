...
@section('title')
<<<<<<< HEAD Parks open and close times=======Parks Time Slot>>>>>>> a54590be918d05c54d8b9bc8006ab4e755bb0bfa
    @endsection
    ...
    <div class="card-box">
        <form class="formSection" action="{{url('/search_park_times')}}" method="GET">
            ...
            <div id="datatable-buttons_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                            <thead>
                                <tr role="row">
                                    ...
                                    <<<<<<< HEAD <th class="sorting" tabindex="0" aria-controls="datatable-buttons"
                                        rowspan="1" colspan="1">
                                        Duration Time
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1"
                                ...
                                <tr role="row" class="odd" id="row-{{ $item->id }}">
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="modal-{{ $item->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <<<<<<< HEAD {!!Form::model($item , ['route'=>
                                                            ['admin.park_times.daily_entrance_count' , $item->id],'id'
                                                            =>
                                                            'ClientStore', 'method' =>
                                                            ...
                                                            <div class="form-line">
                                                                ...
                                                                @endif
                                                                <br><br>
                                                                <<<<<<< HEAD <label class="form-label">Add General
                                                                    Comment On Park </label>
                                                                    <div class="form-line">
                                                                        {!! Form::textArea('general_comment', null,
                                                                        ['class' =>
                                                                        'form-control summernote']) !!}
                                                                        =======
                                                                        <label class="form-label"> General Comment On
                                                                            Park </label>
                                                                        <div class="form-line">
                                                                            {!! Form::textArea('general_comment', null,
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button
                                                                            class="btn btn-primary waves-effect saveProject"
                                                                            type="submit">Save
                                                                        </button>
                                                                    </div>
                                            ...
                                            <<<<<<< HEAD {!!Form::open( ['route'=>
                                                ['admin.park_times.destroy',$item->id]
                                                ,'id'=>'delete-form'.$item->id, 'method' => 'Delete']) !!}
                                                {!!Form::close() !!}
                                    <td>
                                        @if(auth()->user()->can('health_and_safety_reports-create'))
                                        <a
                                            href="{{url('add_health_and_safety_report/'.$item->parks->id.'/'.$item->id)}}">
                                    ...
                                    <td>
                                        <a href="{{ route('admin.park_times.edit', $item) }}" class="btn btn-info">Edit
                                            Park
                                            Time Slot</a>
                ...
                {!!Form::open( ['route' => ['admin.park_times.destroy',$item->id] ,'id'=>'delete-form'.$item->id,
                'method' => 'Delete']) !!}
                {!!Form::close() !!}
                <td>
                    @if(auth()->user()->can('health_and_safety_reports-create'))
                ...
                <td>
                    <a href="{{ url('all-rides/'.$item->parks->id.'/'.$item->id) }}" class="btn btn-info">All Rides </a>
                </td>
                <td>
                    <a href="{{ route('admin.park_times.edit', $item) }}" class="btn btn-info">Edit Park Time Slot</a>
                    ...
                    <a class="btn btn-danger" data-name="{{ $item->name }}"
                        data-url="{{ route('admin.park_times.destroy', $item) }}" onclick="delete_form(this)">
                        Delete
                    </a>
