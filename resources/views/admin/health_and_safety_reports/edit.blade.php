...
@section('content')
{!!Form::open( ['route' => 'admin.updateRequest' ,'class'=>'form phone_validate', 'method' => 'Post', 'enctype'=>"multipart/form-data",'class'=>'form-horizontal','files' => true]) !!}
                        @csrf
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
        ...
        $('.save_btn').on('click',function (e) {
            ...
            $.ajax({
                ...
                success: function(response)
                {
                    if(response.success){
                    swal({
                         title: "Health and Safety Report Updated successfully",
                         icon: "success",
                         buttons: ["Ok"]
                          }); 
