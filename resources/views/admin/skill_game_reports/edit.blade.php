...
@section('Update','update skill Game Report')

@section('content')
{!!Form::open( ['route' => 'admin.updateskillGame' ,'class'=>'form phone_validate', 'method' => 'Post', 'enctype'=>"multipart/form-data",'class'=>'form-horizontal','files' => true]) !!}
                        @csrf
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                <h4 class="header-title m-t-0 m-b-30">Update  Skill Game Report</h4>
            ...
            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                ...
                <tr role="row">
                    <th class="sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1"
                        colspan="1" aria-sort="ascending">Skill Game Daily Report
                    </th>
                    <th class="sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1"
...
@push('scripts')
    ...
    $(document).ready(function () {
        $('.save_btn').on('click',function (e) {
            ...
            $.ajax({
                url: "{{ route('admin.updateskillGame') }}",
                type: 'POST',
                data:{
                    "_token":"{{ csrf_token() }}",
                    answer: answer,
                ...
                success: function(response)
                {
                    if(response.success){
                    swal({
                         title: "skill Game Report Updated successfully",
                         icon: "success",
                         buttons: ["Ok"]
                          }); 
                        ...
                        swal({
                         title: "skill Game Report Already Exist !",
                         icon: "danger",
                         buttons: ["Ok"],
