...
<div class="col-xs-5">
    <div class="form-group form-float">
        ...
        <div class="form-line">
            {!! Form::input('text', 'name_person_informed', null, [
                'class' => 'form-control  ',
                'placeholder' => 'name_person_informed',
            ]) !!}
...
<div class="col-xs-3">
    <div class="form-group form-float">
        ...
        <div class="form-line">
            <input type="hidden" name="accident_book_completed" value="null">
            <!-- Hidden input with value null -->
...
<div class="col-xs-5">
    <div class="form-group form-float">
        ...
        <div class="form-line">
            {!! Form::input('text', 'report_eference_no', null, [
                'class' => 'form-control  ',
...
<div class="col-xs-4">
    <div class="form-group form-float">
        ...
        <div class="form-line">
            <input type="hidden" name="are_witnesses_employees" value="null">
            <!-- Hidden input with value null -->
...
<div class="col-xs-4">
    <div class="form-group form-float">
        ...
        <div class="form-line">
            <input type="hidden" name="witnesses_statements_taken" value="null">
            <!-- Hidden input with value null -->
...
<div class="col-xs-6">
    <div class="form-group form-float">
        ...
        <div class="form-line">
            {!! Form::input('text', 'witnesses_name_one', null, [
                'class' => 'form-control  ',
...
<div class="col-xs-6">
    <div class="form-group form-float">
        ...
        <div class="form-line">
            {!! Form::input('text', 'contact_phone_no_one', null, [
                'class' => 'form-control  ',
...
<div class="col-xs-12">
    <div class="form-group form-float">
        <label class="form-label">Address:</label>
        <div class="form-line">
            {!! Form::input('text', 'witnesses_address_one', null, [
                'class' => 'form-control  ',
                'placeholder' => 'Address',
            ]) !!}
...
<div class="col-xs-6">
    <div class="form-group form-float">
        <label class="form-label">Witness Name:</label>
        <div class="form-line">
            {!! Form::input('text', 'witnesses_name_two', null, [
                'class' => 'form-control  ',
                'placeholder' => 'Witness Name',
            ]) !!}
...
<div class="col-xs-6">
    <div class="form-group form-float">
        <label class="form-label">Contact Phone No:</label>
        <div class="form-line">
            {!! Form::input('text', 'contact_phone_no_two', null, [
                'class' => 'form-control  ',
                'placeholder' => 'Contact Phone No',
            ]) !!}
...
<div class="col-xs-12">
    <div class="form-group form-float">
        <label class="form-label">Address:</label>
        <div class="form-line">
            {!! Form::input('text', 'witnesses_address_two', null, [
                'class' => 'form-control  ',
                'placeholder' => 'Address',
            ]) !!}
...
<div class="col-xs-6">
    <div class="form-group form-float">
        <label class="form-label">Witness Name:</label>
        <div class="form-line">
            {!! Form::input('text', 'witnesses_name_three', null, [
                'class' => 'form-control  ',
                'placeholder' => 'Witness Name',
            ]) !!}
...
<div class="col-xs-6">
    <div class="form-group form-float">
        <label class="form-label">Contact Phone No:</label>
        <div class="form-line">
            {!! Form::input('text', 'contact_phone_no_three', null, [
                'class' => 'form-control  ',
                'placeholder' => 'Contact Phone No',
            ]) !!}
...
<div class="col-xs-12">
    <div class="form-group form-float">
        <label class="form-label">Address:</label>
        <div class="form-line">
            {!! Form::input('text', 'witnesses_address_three', null, [
                'class' => 'form-control  ',
                'placeholder' => 'Address',
            ]) !!}
...
<div class="col-xs-6">
    <div class="form-group form-float">
        ...
        <div class="form-line">
            <input type="hidden" name="was_the_incident_work_related" value="null">
            <!-- Hidden input with value null -->
...
<div class="col-xs-6">
    <div class="form-group form-float">
        ...
        <div class="form-line">
            <input type="hidden" name="was_first_aid_administered_at_location" value="null">
            <!-- Hidden input with value null -->
...
<div class="col-xs-12">
    <div class="form-group form-float">
        ...
        <div class="form-line">
            {!! Form::input('text', 'name_of_first_aider', null, [
                'class' => 'form-control  ',
...
<div class="col-xs-12">
    <div class="form-group form-float">
        ...
        <div class="form-line">
            {!! Form::input('text', 'details_of_injury', null, [
                'class' => 'form-control  ',
...
<div class="col-xs-6">
    <div class="form-group form-float">
        ...
        <div class="form-line">
            <input type="hidden" name="were_emergency_services_called" value="null">
            <!-- Hidden input with value null -->
...
<div class="col-xs-6">
    <div class="form-group form-float">
        ...
        <div class="form-line">
            <input type="hidden" name="was_person_involved_hospitalised" value="null">
            <!-- Hidden input with value null -->
...
<div class="col-xs-12 bottom">
    <table class="bordered-table">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <input type="hidden" name="Slip_Trip_Hazard" value="null">
                    <!-- Hidden input with value null -->
            ...
            <tr>
                <td>
                    <input type="hidden" name="Damaged_Unstable_Floor" value="null">
                    <!-- Hidden input with value null -->
                    <input type="checkbox" name="Damaged_Unstable_Floor" value="Yes" class="ml-3"> Damaged /
                    Unstable Floor
                </td>
                <td>
...
<div class="col-xs-12 bottom">
    <table class="bordered-table">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <input type="hidden" name="Lack_of_Communication" value="null">
                    <!-- Hidden input with value null -->
                    <input type="checkbox" name="Lack_of_Communication" value="Yes" class="ml-3"> Lack of
                    Communication
                </td>
                <td>
            ...
            <tr>
                <td>
                    <input type="hidden" name="Change_of_Routine" value="null">
                    <!-- Hidden input with value null -->
            ...
            <tr>
                <td>
                    <input type="hidden" name="Time_Production_Pressure" value="null">
                    <!-- Hidden input with value null -->
                    <input type="checkbox" name="Time_Production_Pressure" value="Yes" class="ml-3"> Time /
                    Production Pressure
            ...
            <tr>
                <td>
                    <input type="hidden" name="Procedure_No_Followed" value="null">
                    <!-- Hidden input with value null -->
                    <input type="checkbox" name="Procedure_No_Followed" value="Yes" class="ml-3"> Procedure Not
                    Followed
                </td>
                <td>
            ...
            <tr>
                <td>
                    <input type="hidden" name="Drugs_or_Alcohol" value="null">
                    <!-- Hidden input with value null -->
            ...
            <tr>
                <td class="checkbox-cell">
                    <input type="hidden" name="Attribute_Other" value="null">
                    <!-- Hidden input with value null -->
...
<div class="col-xs-12 bottom">
    <table class="bordered-table">
        ...
        <tbody>
            <tr>
                <td>
                    <input type="hidden" name="No_Hazard_Identified" value="null">
                    <!-- Hidden input with value null -->
                    <input type="checkbox" name="No_Hazard_Identified" value="Yes" class="ml-3"> No Hazard
                    Identified
                </td>
                <td>
            ...
            <tr>
                <td>
                    <input type="hidden" name="Inadequate_Safe_Procedure" value="null">
                    <!-- Hidden input with value null -->
                    <input type="checkbox" name="Inadequate_Safe_Procedure" value="Yes" class="ml-3">
                    Inadequate Safe Procedure’s
                </td>
                <td>
            ...
            <tr>
                <td>
                    <input type="hidden" name="Inadequate_Risk_Assessment" value="null">
                    <!-- Hidden input with value null -->
                    <input type="checkbox" name="Inadequate_Risk_Assessment" value="Yes" class="ml-3">
            ...
            <tr>
                <td>
                    <input type="hidden" name="Inadequate_Controls_in_Place" value="null">
                    <!-- Hidden input with value null -->
                    <input type="checkbox" name="Inadequate_Controls_in_Place" value="Yes" class="ml-3">
            ...
            <tr>
                <td>
                    <input type="hidden" name="Inadequate_Training" value="null">
                    <!-- Hidden input with value null -->
                    <input type="checkbox" name="Inadequate_Training" value="Yes" class="ml-3"> Inadequate
                    Training
            ...
            <tr>
                <td>
                    <input type="hidden" name="Lack_of_Supervision" value="null">
                    <!-- Hidden input with value null -->
                    <input type="checkbox" name="Lack_of_Supervision" value="Yes" class="ml-3"> Lack of
                    Supervision
            ...
            <tr>
                <td class="checkbox-cell">
                    <input type="hidden" name="Attribute_two_Other" value="null">
                    <!-- Hidden input with value null -->
...
<div class="col-xs-12 bottom">
    <table class="bordered-table">
        ...
        <tbody>
            <tr>
                <td>
                    <input type="hidden" name="Incorrect_Equipment" value="null">
                    <!-- Hidden input with value null -->
                    <input type="checkbox" name="Incorrect_Equipment" value="Yes" class="ml-3"> Incorrect
                    Equipment
            ...
            <tr>
                <td>
                    <input type="hidden" name="Equipment_Failure" value="null">
                    <!-- Hidden input with value null -->
            ...
            <tr>
                <td>
                    <input type="hidden" name="Inadequate_Maintenance" value="null">
                    <!-- Hidden input with value null -->
                    <input type="checkbox" name="Inadequate_Maintenance" value="Yes" class="ml-3"> Inadequate
                    Maintenance
                </td>
                <td>
            ...
            <tr>
                <td>
                    <input type="hidden" name="Heavy_or_Awkward" value="null">
                    <!-- Hidden input with value null -->
            ...
            <tr>
                <td>
                    <input type="hidden" name="Inadequate_Training_two" value="null">
                    <!-- Hidden input with value null -->
                    <input type="checkbox" name="Inadequate_Training_two" value="Yes" class="ml-3"> Inadequate
                    Training
            ...
            <tr>
                <td>
                    <input type="hidden" name="Inadequate_Guarding" value="null">
                    <!-- Hidden input with value null -->
                    <input type="checkbox" name="Inadequate_Guarding" value="Yes" class="ml-3"> Inadequate
                    Guarding
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    <p class="bold"> Risk Assessments, Witness Statements, Method Statements, Location Photographs,
                        Training documents, Accident Book copy and any other related documents or evidence to be
                        forwarded to Mellors Group Head Office.
                    </p>
                    <p class="bold" style="text-align:center;"> Email All Information to: p.pearson@mellorsgroup.com
                        or j.pearson@mellorsgroup.com
                    </p>
                </td>
            </tr>
...
<div class="col-xs-12 bottom">
    <table class="bordered-table">
        ...
        <tbody>
            <tr>
                <td>
                    {!! Form::textArea('Further_Information', null, [
