...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                <h4 class="header-title m-t-0 m-b-30">update department {{ $branch->name }} </h4>
                <a class="input-group-btn" href="{{route('admin.departments.index')}}">
                    <button type="button" class="btn waves-effect waves-light btn-primary">back</button>
                            ...
                            {!!Form::model($branch , ['route' => ['admin.departments.update' , $branch->id] , 'method' => 'PATCH','enctype'=>"multipart/form-data",'files' => true,'id'=>'form']) !!}
